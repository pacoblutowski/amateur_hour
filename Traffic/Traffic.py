...
def main():
	...
	villain_1 = pygame.image.load('Traffic/Graphics/Blue_Ford.png').convert_alpha()
	villain_1_rect = villain_1.get_rect(topleft = (villain1_x_pos,villain1_y_pos))
	villain_2 = pygame.image.load('Traffic/Graphics/Black_Ford.png').convert_alpha()
	villain_2_rect = villain_2.get_rect(topleft = (villain2_x_pos,villain2_y_pos))
	finish_line = pygame.image.load('Traffic/Graphics/Finish.png').convert_alpha()
